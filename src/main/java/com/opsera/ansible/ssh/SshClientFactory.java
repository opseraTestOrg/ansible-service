 ...
 * <p>
 * Create a new instance of {@link SshClientSSHJ} with
 * {@link #newInstance(SshClientConfig)}
 * <p>
 * Create a custom implementation of {@link SshClient} with
 * {@link #newInstance(SshClientConfig, SshClientPoolConfig)}
 * 
 * @author sreeni
 *
 */
public class SshClientFactory {
     ...
     * @return SshClient in inited state
     * @throws RuntimeException if SshClientImplClass in {@code poolConfig} is
     *                          invalid
     */
