 ...
 * <a href="https://docs.ansible.com/ansible/latest/modules/git_module.html">git
 * module</a>.
 * 
 * @author sreeni
 *
...
public class GitCommand extends Command {
     ...
     * @param gitRepo           git, SSH, or HTTP(S) protocol address of the git
     *                          repository.
     * @param destDirectory     The path of where the repository should be checked
     *                          out.
