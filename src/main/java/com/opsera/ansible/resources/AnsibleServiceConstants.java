...
public class AnsibleServiceConstants {
    ...
    public static final String FILE_CREATION_SERVICE_IMPL_INFO = "Starting to get Ansible server DTO object from GenericPlaybookServiceImpl::getAnsiblePlaybookRequest";
    ...
    public static final String EXECUTING_PLAYBOOK_COMMAND_THROUGH_ANSIBLE_CLIENT_MSG_ERROR = "Error while executing playbook command through  Ansible Client : {} {}";
    ...
    public static final String EXECUTING_PING_COMMAND_THROUGH_ANSIBLE_CLIENT_MSG_ERROR = "Error while executing ping command through  Ansible Client: {}";
    ...
    public static final String PARSING_PLAY_BOOK_RESPONSE_FROM_ANSIBLE_MSG_ERROR = "Error while parsing playbook response received from  Ansible server : {} ";
    ...
    public static final String EXECUTING_PLAYBOOK_COMMAND_WITH_ARGS_THROUGH_ANSIBLE_CLIENT_MSG_ERROR = "Error while executing playbook in Ansible server by passing arguments : {} ";
    ...
    public static final String EXECUTION_FAILED_WHILE_VALIDATING_INPUT_MSG_ERROR = "Error in validation of input fields in CommandService::validatePayloadforCommand : {} ";
    ...
    public static final String EXECUTION_FAILED_WHILE_VALIDATING_FILE_CREATION_PAYLOAD_INPUT_MSG_ERROR = "Error in validation of file creation payload in CommandService::validatePayloadforFileCreation : {}";
    ...
    public static final String EXECUTION_FAILED_WHILE_FORMATTING_RESPONSE_MSG_ERROR = "Error while formatting the error response from input payload : {}";
    public static final String EXECUTION_FAILED_WHILE_CREATING_ANSIBLE_CLIENT_ERROR = "Error while creating Ansible client";
    public static final String EXECUTION_FAILED_WHILE_CREATING_ANSIBLE_CLIENT_MSG_ERROR = "Error while creating Ansible client : {}";
    public static final String EXECUTION_FAILED_WHILE_EXECUTING_PLAYBOOK_ANSIBLE_SERVER_ERROR = "Error while executing playbook in ansible server";
    public static final String EXECUTION_FAILED_WHILE_EXECUTING_PLAYBOOK_ANSIBLE_SERVER_MSG_ERROR = "Error while executing playbook in ansible server : {} {}";
    public static final String EXECUTION_FAILED_WHILE_EXECUTING_DELETE_CHECKOUT_FOLDER_PLAYBOOK_ANSIBLE_SERVER_ERROR = "Error while executing delete checkout folder playbook in ansible server";
    public static final String EXECUTION_FAILED_WHILE_EXECUTING_DELETE_CHECKOUT_FOLDER_PLAYBOOK_ANSIBLE_SERVER_MSG_ERROR = "Error while executing delete checkout folder playbook in ansible server : {}";
    public static final String EXECUTION_FAILED_WHILE_EXECUTING_DOWNLOAD_GITHUB_FOLDER_PLAYBOOK_ANSIBLE_SERVER_MSG_ERROR = "Error while executing download from git hub playbook in ansible server : {}";
    public static final String EXECUTION_FAILED_WHILE_EXECUTING_DOWNLOAD_GITHUB_FOLDER_PLAYBOOK_ANSIBLE_SERVER_ERROR = "Error while executing download from git hub playbook in ansible server";
    public static final String EXECUTION_FAILED_WHILE_EXECUTING_PLAYBOOK_SERVICE_ANSIBLE_SERVER_ERROR = "Error while executing playbook service in ansible server";
    public static final String EXECUTION_FAILED_WHILE_EXECUTING_PLAYBOOK_SERVICE_ANSIBLE_SERVER_MSG_ERROR = "Error while executing playbook service in ansible server : {} ";
    ...
    public static final String EXECUTING_DELETE_CHECKOUT_SERVICE_IMPL_MSG_ERROR = "Error while executing in DeleteCheckoutFolderServiceImpl::getAnsiblePlaybookRequest : {} ";
    public static final String EXECUTING_FILE_CREATION_SERVICE_IMPL_ERROR = "Error while executing in GenericPlaybookServiceImpl::getAnsiblePlaybookRequest";
    
    public static final String EXECUTING_FILE_CREATION_SERVICE_IMPL_MSG_ERROR = "Error while executing in GenericPlaybookServiceImpl::getAnsiblePlaybookRequest : {}" ;
    ...
    public static final String EXECUTING_DOWNLOAD_GIT_CHECKOUT_SERVICE_IMPL_MSG_ERROR = "Error while executing in DownloadGitServiceImpl::getAnsiblePlaybookRequest : {}";
    public static final String EXECUTION_FAILED_WHILE_GETTING_ANSIBLE_SERVICE_IMPL_ERROR = "Error while getting Ansible Service Impl in AnsibleServiceFactory::getAnsibleService";
    public static final String EXECUTION_FAILED_WHILE_GETTING_ANSIBLE_SERVICE_IMPL_MSG_ERROR = "Error while getting Ansible Service Impl in AnsibleServiceFactory::getAnsibleService : {}" ;
    ...
    public static final String EXECUTION_FAILED_WHILE_VALIDATING_PING_RESPONSE_MSG_ERROR = "Error while formatting the error response from ping command execution : {}";
    ...
    public static final String EXECUTION_FAILED_WHILE_FORMATTING_CUSTOM_PING_FAILURE_RESPONSE_MSG_ERROR = "Error while formatting custom failure error response from ping command execution : {}";
    ...
    public static final String ERROR_WHILE_RETRIVING_TOOL_CONFIG_DETAILS_FROM_ENDPOINT_ERROR = "Error while retriving Tool config details in ToolConfigurationService :: getToolConfigurationDetails";
    public static final String ERROR_WHILE_RETRIVING_TOOL_CONFIG_DETAILS_FROM_ENDPOINT_MSG_ERROR = "Error while retriving Tool config details in ToolConfigurationService :: getToolConfigurationDetails : {}";

    public static final String ERROR_WHILE_SETTING_TOOL_CONFIG_DETAILS_FOR_ANSIBLE_CLIENT_ERROR = "Error while setting  Tool config details in CommandService :: setAnsibleClientConnectionDetails";
    public static final String ERROR_WHILE_SETTING_TOOL_CONFIG_DETAILS_FOR_ANSIBLE_CLIENT_MSG_ERROR = "Error while setting  Tool config details in CommandService :: setAnsibleClientConnectionDetails : {}";
